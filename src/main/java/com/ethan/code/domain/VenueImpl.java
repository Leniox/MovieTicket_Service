...
public class VenueImpl implements Venue {
     ...
     * I also give the row higher weight than column, because people prefer sit in the middle row instead of middle column if they
     * can only choose one. So that's the reason why you see (rowScore * 2 + colScore * 1) / 3 at the end.
     *
